 ...
 * @author pc2
 */
public class frmListaCreditoDeclaracaoEntrega extends javax.swing.JFrame {

   Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public frmListaCreditoDeclaracaoEntrega() {
        initComponents();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         int row = tblPedidoCredito.getSelectedRow();
          int coluna = Integer.parseInt(tblPedidoCredito.getValueAt(row, 0).toString()) ;
            try {
                frmDeclaracaoEntrega.captura(coluna);
                dispose();
            } catch (Exception e5) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListaCreditoDeclaracaoEntrega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListaCreditoDeclaracaoEntrega().setVisible(true);
            }
        });
    }
