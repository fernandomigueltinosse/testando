 ...
 * @author pc2
 */
public class frmListaCreditoVenda extends javax.swing.JFrame {

   Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public frmListaCreditoVenda() {
        initComponents();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         int row = tblPedidoCredito.getSelectedRow();
           ...
           String coluna1 = tblPedidoCredito.getValueAt(row, 1).toString() ;
           String coluna2 = tblPedidoCredito.getValueAt(row, 2).toString() ;
           String coluna3 = tblPedidoCredito.getValueAt(row, 3).toString() ;
            try {
                frmGestaoDeVendas.captura4(coluna,coluna1,coluna2,coluna3);
                dispose();
            } catch (Exception e5) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListaCreditoVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListaCreditoVenda().setVisible(true);
            }
        });
    }
