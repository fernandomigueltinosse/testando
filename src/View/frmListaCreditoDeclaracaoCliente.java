 ...
 * @author pc2
 */
public class frmListaCreditoDeclaracaoCliente extends javax.swing.JFrame {

   Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public frmListaCreditoDeclaracaoCliente() {
        initComponents();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         int row = tblPedidoCredito.getSelectedRow();
           int coluna = Integer.parseInt(tblPedidoCredito.getValueAt(row, 0).toString()) ;
            ...
            try {
                frmDeclaracaoCliente.captura(coluna);
                dispose();
            } catch (Exception e5) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListaCreditoDeclaracaoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListaCreditoDeclaracaoCliente().setVisible(true);
            }
        });
    }
